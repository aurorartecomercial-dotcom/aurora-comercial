...
// ✅ Adicionamos um try/catch global para evitar que erros travem a página
function iniciarAdmin() {
    try {
        ...
        // ✅ CORREÇÃO AQUI: Try/catch no carregamento dos produtos
        async function carregarProdutos() {
            try {
                ...
                produtos = [];
                renderizarLista();
                // ✅ Mostra mensagem visível para o utilizador
                mostrarMensagem('⚠️ Erro ao carregar produtos: ' + e.message, 'info');
            }
        }
        ...
        window.excluirProduto = async function(id) {
            ...
            try {
                ...
                mostrarMensagem('Erro ao excluir: ' + e.message, 'info');
            }
        };
        ...
        alert('Ocorreu um erro ao inicializar o painel: ' + e.message);
    }
}