...
async function carregarDados() {
    try {
        ...
        const resProdutos = await fetch(`https://api.jsonbin.io/v3/b/${CONFIG.BIN_ID_PRODUTOS}/latest`, {
...
// ============================================================
// FUNÇÃO DE EXPORTAÇÃO DO PDF (COMPLETA E PROFISSIONAL)
// ============================================================
async function exportarPDF() {
    ...
    // ---- CABEÇALHO COM LOGO ----
    // Adiciona o logo da Aurora (se disponível)
    try {
    ...
    // Pega os 5 produtos mais vendidos para o gráfico
    const corpoTabela = document.getElementById('corpoTabelaRelatorio');
